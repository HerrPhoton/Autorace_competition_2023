...
Вначале робот определяет белую и желтую линии на трансформированном изображении, поступающего с камеры. Вычисляет координату x, на которой находится центр между линиями.
Далее, принимая координату центра между белой и желтой линиями, робот производит корректировку направления движения, чтобы двигаться по центру полосы.
...
Когда робот подъезжает к перекрестку, он вначале замечает знак препятствия, который сигнализирует о уменьшении скорости. После этого распознается знак поворота, в направлении которого необходимо двигаться. Робот принудительно поворачивает в соответствующую сторону, после чего робот снова следует вдоль полосы по PID. 
...
+ Среднее время прохождение дистанции: 90 секунд
